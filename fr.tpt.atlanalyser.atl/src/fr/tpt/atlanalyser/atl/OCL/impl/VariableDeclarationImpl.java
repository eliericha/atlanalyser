 ...
 * <ul>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getId <em>Id</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getInitExpression <em>Init Expression</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getLetExp <em>Let Exp</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getBaseExp <em>Base Exp</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.VariableDeclarationImpl#getVariableExp <em>Variable Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
