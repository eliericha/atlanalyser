 ...
 * <ul>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getIfExp3 <em>If Exp3</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getAppliedProperty <em>Applied Property</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getCollection <em>Collection</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getLetExp <em>Let Exp</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getLoopExp <em>Loop Exp</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getParentOperation <em>Parent Operation</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getInitializedVariable <em>Initialized Variable</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getIfExp2 <em>If Exp2</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getOwningOperation <em>Owning Operation</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getIfExp1 <em>If Exp1</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclExpressionImpl#getOwningAttribute <em>Owning Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class OclExpressionImpl extends LocatedElementImpl implements OclExpression {
     ...
     */
    public String print() {
        return (new OCLExpressionSimplePrinter()).print(this);
    }
