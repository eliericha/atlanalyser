 ...
 * <ul>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getOclExpression <em>Ocl Expression</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getMapType2 <em>Map Type2</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getMapType <em>Map Type</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getCollectionTypes <em>Collection Types</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getTupleTypeAttribute <em>Tuple Type Attribute</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.OCL.impl.OclTypeImpl#getVariableDeclaration <em>Variable Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
