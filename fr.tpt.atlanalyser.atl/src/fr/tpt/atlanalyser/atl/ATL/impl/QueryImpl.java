 ...
 * <ul>
 *   <li>{@link fr.tpt.atlanalyser.atl.ATL.impl.QueryImpl#getBody <em>Body</em>}</li>
 *   <li>{@link fr.tpt.atlanalyser.atl.ATL.impl.QueryImpl#getHelpers <em>Helpers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QueryImpl extends UnitImpl implements Query {
    ...
    /**
     * The cached value of the '{@link #getHelpers() <em>Helpers</em>}' reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getHelpers()
     * @generated
    ...
    public EList<Helper> getHelpers() {
        if (helpers == null) {
            helpers = new EObjectWithInverseResolvingEList<Helper>(Helper.class, this, ATLPackage.QUERY__HELPERS, ATLPackage.HELPER__QUERY);
        }
        return helpers;
    }
