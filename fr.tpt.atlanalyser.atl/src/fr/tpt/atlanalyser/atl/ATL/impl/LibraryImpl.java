 ...
 * <ul>
 *   <li>{@link fr.tpt.atlanalyser.atl.ATL.impl.LibraryImpl#getHelpers <em>Helpers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LibraryImpl extends UnitImpl implements Library {
    ...
    public EList<Helper> getHelpers() {
        if (helpers == null) {
            helpers = new EObjectWithInverseResolvingEList<Helper>(Helper.class, this, ATLPackage.LIBRARY__HELPERS, ATLPackage.HELPER__LIBRARY);
        }
        return helpers;
    }
