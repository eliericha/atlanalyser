...
public class TestInjectivityIssuesExec extends GenericExecTest {

    private static final String BASEDIR = "examples/InjectivityIssues";

    public TestInjectivityIssuesExec(File inputModel) {
