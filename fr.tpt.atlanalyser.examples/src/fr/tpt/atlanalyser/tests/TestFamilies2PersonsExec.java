...
public class TestFamilies2PersonsExec extends GenericExecTest {

    private static final String BASEDIR = "examples/Families2Persons";

    public TestFamilies2PersonsExec(File inputModel) {
