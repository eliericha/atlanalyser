...
public class TestClass2RelationalPost2Pre extends GenericPost2PreTest {
        ...
        try {
            ...
            if (cmd.hasOption("h")) {
                new HelpFormatter().printHelp(
                        TestClass2RelationalPost2Pre.class.getSimpleName(),
                        options);
                System.exit(0);
            }
            ...
            new HelpFormatter().printHelp(
                    TestClass2RelationalPost2Pre.class.getSimpleName(), options);
            System.exit(1);
        }
    ...
    private static final String BASEDIR = "examples/Class2Relational";

    public TestClass2RelationalPost2Pre(File inputModel, int jobs) {
        super(BASEDIR, inputModel, jobs);
    }

    public TestClass2RelationalPost2Pre(File inputModel) {
        this(inputModel, 2);
    }
