...
public class TestSimpleCMG1Exec extends GenericExecTest {

    private static final String BASEDIR = "examples/SimpleCMG1";

    public TestSimpleCMG1Exec(File inputModel) {
