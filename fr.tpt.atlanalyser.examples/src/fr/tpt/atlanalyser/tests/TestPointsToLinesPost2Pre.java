...
public class TestPointsToLinesPost2Pre extends GenericPost2PreTest {
        ...
        try {
            ...
            if (cmd.hasOption("h")) {
                new HelpFormatter().printHelp(
                        TestPointsToLinesPost2Pre.class.getSimpleName(),
                        options);
                System.exit(0);
            }
            ...
            new HelpFormatter().printHelp(
                    TestPointsToLinesPost2Pre.class.getSimpleName(), options);
            System.exit(1);
        }
