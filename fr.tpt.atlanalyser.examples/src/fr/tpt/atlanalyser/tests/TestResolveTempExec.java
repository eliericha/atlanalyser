...
public class TestResolveTempExec extends GenericExecTest {

    private static final String BASEDIR = "examples/ResolveTemp";

    public TestResolveTempExec(File inputModel) {
